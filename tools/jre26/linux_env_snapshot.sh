...
# 用法（容器内）:
#   sh /mnt/linux_share/Documents/Meow/Codes/HMOS/HarmonyOS_Projects/HarmonyOS_Projects/Meowcraft/Harmomeow-Craft-Launcher/tools/jre26/linux_env_snapshot.sh
set -u
echo "===== 1. 平台 ====="
uname -a
echo "arch: $(uname -m)"
...
BOOT="$SHARE/stuffs/research/jdk26/linux-bootjdk"
...
echo; echo "（把以上输出整段贴回 tools/jre26/README.md 的「溯源」段。）"
