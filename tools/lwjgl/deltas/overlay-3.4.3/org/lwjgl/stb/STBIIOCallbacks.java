...
public class STBIIOCallbacks extends Struct<STBIIOCallbacks> implements NativeResource {
    ...
    // Meowcraft 3.4.x compat shim: LWJGL 3.4.0 removed the deprecated struct statics
    // mallocStack()/callocStack(), but Minecraft <= 1.18.2 still links
    // STBIIOCallbacks.mallocStack(MemoryStack) (stb_image from-memory loading). Re-add
    // them, delegating to the surviving malloc/calloc. See tools/lwjgl/README.md.
