...
public class STBVorbisInfo extends Struct<STBVorbisInfo> implements NativeResource {
    ...
    // mallocStack()/callocStack(), but Minecraft <= 1.19.4 still links
    // STBVorbisInfo.mallocStack(MemoryStack) (OGG/Vorbis audio decode). Re-add them,
    // delegating to the surviving malloc/calloc. See tools/lwjgl/README.md.
